...
namespace OBSync.Models.OBDataSources
{
    ...
    public partial class fp_events
    {
        ...
        public string invite_templates { get; set; }
        public string accept_redirect { get; set; }
        public string decline_redirect { get; set; }
        public string activity_status_type { get; set; }
    }
}
